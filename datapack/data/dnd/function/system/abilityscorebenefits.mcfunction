...
execute unless score @s abilityDEX matches 10 run attribute @s attack_speed modifier remove dnd:abilityscore10
execute unless score @s abilityDEX matches 11 run attribute @s attack_speed modifier remove dnd:abilityscore10
execute unless score @s abilityDEX matches 12 run attribute @s attack_speed modifier remove dnd:abilityscore10
execute unless score @s abilityDEX matches 13 run attribute @s attack_speed modifier remove dnd:abilityscore10
execute unless score @s abilityDEX matches 14 run attribute @s attack_speed modifier remove dnd:abilityscore10
execute unless score @s abilityDEX matches 15 run attribute @s attack_speed modifier remove dnd:abilityscore10
execute unless score @s abilityDEX matches 16 run attribute @s attack_speed modifier remove dnd:abilityscore10
execute unless score @s abilityDEX matches 17 run attribute @s attack_speed modifier remove dnd:abilityscore10
execute unless score @s abilityDEX matches 18 run attribute @s attack_speed modifier remove dnd:abilityscore10
execute unless score @s abilityDEX matches 19 run attribute @s attack_speed modifier remove dnd:abilityscore10
execute unless score @s abilityDEX matches 20 run attribute @s attack_speed modifier remove dnd:abilityscore10

execute if score @s abilityDEX matches 10 run attribute @s attack_speed modifier add dnd:abilityscore10 0 add_value
execute if score @s abilityDEX matches 11 run attribute @s attack_speed modifier add dnd:abilityscore10 0.4 add_value
execute if score @s abilityDEX matches 12 run attribute @s attack_speed modifier add dnd:abilityscore10 0.8 add_value
execute if score @s abilityDEX matches 13 run attribute @s attack_speed modifier add dnd:abilityscore10 1.2 add_value
execute if score @s abilityDEX matches 14 run attribute @s attack_speed modifier add dnd:abilityscore10 1.6 add_value
execute if score @s abilityDEX matches 15 run attribute @s attack_speed modifier add dnd:abilityscore10 2.0 add_value
execute if score @s abilityDEX matches 16 run attribute @s attack_speed modifier add dnd:abilityscore10 2.4 add_value
execute if score @s abilityDEX matches 17 run attribute @s attack_speed modifier add dnd:abilityscore10 2.8 add_value
execute if score @s abilityDEX matches 18 run attribute @s attack_speed modifier add dnd:abilityscore10 3.2 add_value
execute if score @s abilityDEX matches 19 run attribute @s attack_speed modifier add dnd:abilityscore10 3.6 add_value
execute if score @s abilityDEX matches 20 run attribute @s attack_speed modifier add dnd:abilityscore10 4.0 add_value