...
execute as @s run attribute @s minecraft:scale base set 0.91
execute as @s run attribute @s minecraft:jump_strength base set 0.4092
execute as @s run attribute @s minecraft:step_height base set 0.6
execute as @s run tag @s add antiWither
execute as @s run tag @s add freePearls
