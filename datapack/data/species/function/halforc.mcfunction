...
execute as @s run attribute @s minecraft:scale base set 0.96
execute as @s run attribute @s minecraft:jump_strength base set 0.4152
execute as @s run attribute @s minecraft:step_height base set 0.6
execute as @s run tag @s add nightVision
execute as @s run tag @s add extraDamageWhenLowHealth
