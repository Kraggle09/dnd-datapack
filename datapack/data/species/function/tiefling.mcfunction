...
execute as @s run attribute @s minecraft:scale base set 0.93
execute as @s run attribute @s minecraft:jump_strength base set 0.4116
execute as @s run tag @s add nightVision
execute as @s run tag @s add fireResistance
